...
},{"prompt-sync":3}],2:[function(require,module,exports){
'use strict';
...
},{"_process":9,"buffer":7,"fs":5,"strip-ansi":4}],4:[function(require,module,exports){
'use strict';
...
},{"ansi-regex":2}],5:[function(require,module,exports){
...
square.forEach(sqr => {
  sqr.onclick = () => {
     timesclicked[sqr.value] += 1;
     sqr.innerText = timesclicked[sqr.value]
    //console.log(sqr.value)
  }
});

function cleargmebtn(){
  square.forEach(sqr => {
      sqr.innerText = '';
  })
};

const cleargmeBtn = document.getElementById('cleargame_btn');
cleargmeBtn.onclick = () => cleargmebtn();